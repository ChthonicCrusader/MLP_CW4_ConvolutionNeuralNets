...
import numpy as np
from mlp.data_providers import CIFAR100DataProvider
import time
print "Job Started"
...
def conv_net(x):
    ...
    #Affine Layer
    w_fc1 = assign_weights([8*8*200,1024])
    ...
    #output layer
    w_fc2 = assign_weights([1024,100])
    b_fc2 = assign_bias([100])
...
np.savez_compressed(
    os.path.join(exp_dir, 'exp_run_cnn_avg2'+str(num_epoch)+'_100.npz'),
